...
<body>
  ...
  <header>
    <img src="CREATIVE_EYE_CENTER.png" alt="logo" class="headerlogo">
    <h1 class="display-1 p-5 indexheader">Eye Care Doctors of Optometry</h1>
  </header>
  <main class="container center">
    <h3 class="display-4">Protecting Sight | Enhancing Vision</h3>
    <p>We pride ourselves on our knowlegable employees and the technology we use to treat our patients, Optos. Optos
      is cutting edge technology that allows us to see over 80% of your Retina, and any problems it may reveal, in
      a single image. This is over 4x more than any previous method, and we are one of a few practices in Virginia
      that have this inovative technology.</p>
  </main>
  <footer class="p-5">
